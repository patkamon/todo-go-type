// import { Box, Checkbox, CheckboxIcon, List, ThemeIcon } from '@mantine/core';
...
//         icon={
//           todo.done ? (<ThemeIcon color="teal" size={24} radius='xl'><CheckCircleFillIcon size={20}/></ThemeIcon>)
//           :
